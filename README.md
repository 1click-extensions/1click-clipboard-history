# <a href="https://1ce.org/1click-clipboard-history">1CE - 1Click clipboard history</a>

The easiest and cleverest way to use your recent copy-n-paste texts!

Usage Guide:

1. Install the extension (click "Add to Chrome")
2. Copy texts
3. click on browseraction
4. choose from list the text you copied recently.
5. Now you can paste it anywhere.
...
The easiet way to install the plugin, is going to [1CE - 1Click clipboard history website](https://1ce.org/1click-clipboard-history), and then add it to chrome.
...
<a href="https://1ce.org/1click-clipboard-history/video">
